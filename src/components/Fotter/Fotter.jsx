      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              {['Home', 'Contact', 'About Us'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-gray-600 hover:text-purple-900 transition duration-300">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              {/* GitHub */}
              <a href="#" className="flex items-center text-sm text-gray-600 hover:text-[#181717] transition duration-300">
              ...
              {/* Twitter (X) */}
              <a href="#" className="flex items-center text-sm text-gray-600 hover:text-[#000000] transition duration-300">
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="#" className="flex items-center text-sm text-gray-600 hover:text-[#0A66C2] transition duration-300">
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
