      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <h3 className="text-base font-semibold text-gray-900">Main</h3>
            <ul className="space-y-2">
              {['Home', 'Contact', 'About Us'].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item === 'Home' ? '' : item.toLowerCase().replace(' ', '-')}`}
                    className="text-sm text-gray-600 hover:text-purple-900 transition duration-300"
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              {['Book Event', 'Organise Event', 'Update Events'].map((item) => (
                <li key={item}>
                  <Link
                    to={`/${item=='Book Event'? 'events' : item==='Organise Event' ? 'add-event' : 'dashboard' }`}
                    className="text-sm text-gray-600 hover:text-purple-900 transition duration-300"
                  >
                    {item}
                  </Link>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center text-sm text-gray-600 hover:text-[#181717] transition duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-sm text-gray-600 hover:text-[#000000] transition duration-300"
              >
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-sm text-gray-600 hover:text-[#0A66C2] transition duration-300"
              >
                <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          <p className="text-xs md:text-sm text-gray-600">
            Made with ❤️ and ☕ in India © {currentYear}
          </p>
        </div>
      </div>
    </footer>
